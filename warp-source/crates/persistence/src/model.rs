...
use super::schema::{
    ...
    teams, terminal_panes, user_profiles, vesper_usage, welcome_panes, windows, workflow_panes,
...
#[diesel(table_name = vesper_usage, primary_key(provider))]
pub struct VesperUsage {
    pub provider: String,
    pub daily_tokens_used: i64,
    pub last_reset_at: NaiveDateTime,
}

#[derive(Insertable, AsChangeset)]
#[diesel(table_name = vesper_usage)]
pub struct NewVesperUsage<'a> {
    pub provider: &'a str,
    pub daily_tokens_used: i64,
    pub last_reset_at: NaiveDateTime,
}
