    ...
    fn new(
        ...
        let accounts = vec![
            ...
            ai::InferenceAccount {
                id: "groq-2".to_owned(),
                provider: "groq".to_owned(),
                api_key: std::env::var("GROQ_API_KEY_2").unwrap_or_default(),
                base_url: "https://api.groq.com/openai/v1".to_owned(),
                model: "llama3-70b-8192".to_owned(),
                daily_limit: 100000,
            },
            ai::InferenceAccount {
                id: "groq-3".to_owned(),
                provider: "groq".to_owned(),
                api_key: std::env::var("GROQ_API_KEY_3").unwrap_or_default(),
                base_url: "https://api.groq.com/openai/v1".to_owned(),
                model: "llama3-70b-8192".to_owned(),
                daily_limit: 100000,
            },
            ai::InferenceAccount {
                ...
                base_url: format!(
                    ...
                    std::env::var("VESPER_CF_ID").unwrap_or_else(|_| "REDACTED".to_string())
                ),
