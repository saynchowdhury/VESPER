...
const steps = [
  {
    ...
    description: "Map your exact coding patterns and verification steps into Vesper's skill architecture using natural language or JSON.",
    code: `// .agents/skills/refactor.json
{
  "name": "Surgical Refactor",
  "process": ["research", "plan", "act", "validate"],
  "rules": ["no-ui-regressions", "idiomatic-only"]
}`,
  },
  {
    number: "02",
    title: "Launch",
    subtitle: "Vesper terminal",
    description: "Open your native Vesper terminal on macOS or Windows. Your custom skills are pre-loaded and ready to execute.",
    code: `$ vesper run "refactor the auth layer"
> Loading surgical-refactor skill...
> Using Vesper Smart Router (Groq)...
> Analysis complete. Ready to plan.`,
  },
  {
    number: "03",
    title: "Scale",
    subtitle: "with precision",
    description: "Let the agent execute your process at scale. Intelligent multi-provider routing ensures zero latency and minimal cost.",
    code: `// Vesper Smart Routing
const router = new VesperRouter({
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block">Encode.</span>
              <span className="block text-white/30">Run.</span>
