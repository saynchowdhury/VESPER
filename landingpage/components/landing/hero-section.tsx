...
const words = ["optimized", "elevated", "accelerated", "refined"];
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            Your custom coding process, pre-loaded.
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block whitespace-nowrap">Your process.</span>
        ...
        {/* CTA */}
        <div 
          className={`flex flex-col sm:flex-row items-center gap-6 transition-all duration-1000 delay-300 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
          <Button 
